...
const Container = tw.div`relative h-1/4 bg-givry-500`;
...
export default ({
  subheading = "",
  heading = "Fill In Donation Form",
  description = "Fill in the donation form with your details and contact information, let us do our bit to help change the world as little acts of kindness go a verly long way, indeed!",
  imageSrc = Photo5,
  imageContain = false,
  imageShadow = true,
  faqs = null,
