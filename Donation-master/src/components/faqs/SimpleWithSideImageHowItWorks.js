...
const Container = tw.div`relative h-1/4 bg-peachy-400`;
...
const Description = tw.p`max-w-xl leading-10 text-center mx-auto mb-10 lg:mx-0 lg:text-left  text-sm sm:text-base lg:text-xl font-medium mt-4 text-black`;
...
export default ({
  ...
  description = "Choose a cause from a number of campaigns hosted on the website and donate to the one of your choice. We partner with NGOs all over India to help aid the poor and the marginalized. Join us in making the world a better place, one campaign at a time",
  imageSrc = Photo4,
  imageContain = false,
  imageShadow = true,
  faqs = null,
