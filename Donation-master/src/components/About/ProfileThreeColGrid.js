...
const Subheading = tw(SubheadingBase)`text-center text-axolotl-400 mb-3`
const Description = tw(SectionDescription)`mx-auto text-axolotl-700 text-center`
...
const CardContent = styled.div`
  ...
  .position {
    ${tw`uppercase font-bold tracking-widest text-xs text-axolotl-500`}
  }
  .name {
...
const CardLinks = styled.div`
  ${tw`mt-6 flex`}
  .link {
    ${tw`mr-8 last:mr-0 text-axolotl-200 hocus:text-yellow-500 transition duration-300`}
    .icon {
...
export default ({
  ...
  cards = [
    ...
    },
    {
     ...
     {
      imageSrc: "https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=80",
      position: "Jr. Designer",
      name: "Leonard Rodricks",
      links: [
        {
          url: "https://twitter.com",
          icon: TwitterIcon,
